...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "📕Name ➠ : @animecore4u {filename}")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", "📕Name ➠ : @animecore4u {filename}")
